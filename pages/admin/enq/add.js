    ...
    <>
        <div className='BREADCRUMBS my-8 ml-10 opacity-75 text-gray-700'>
          <div className='flex flex-row text-sm'>
            ...
            <AiOutlineRight size={'0.8em'} className="mt-[0.2rem] mx-2 text-gray-700"/>
            <p className='font-medium'>Add Enquiry</p>
          </div>
        </div>
        <form onSubmit={submitContact}>
        <div className='flex flex-row justify-between '>
            <h1 className='text-[2.1rem] font-light mx-16 mt-2 px-12'>Add Enquiry</h1>
                  ...
                  <div className='DETAILS mb-5'>
                    ...
                    <div className='py-2 px-3'>
                      <div className='BOX-ITEM flex flex-row'>
                        ...
                        <textarea name="comments" defaultValue="" className='font-light ml-5 px-[0.8rem] pb-[0.05rem] pt-[0.35rem] border-gray-200 border rounded-md' />
                      </div>
                    </div>
                  </div>
              </div>
